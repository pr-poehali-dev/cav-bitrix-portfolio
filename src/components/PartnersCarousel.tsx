...
const PartnersCarousel = () => {
  ...
  return (
    <div className="relative w-full py-8 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border-t border-gradient-start/10 dark:border-gradient-start/20 rounded-t-[30px] mx-[50px] max-w-[calc(100%-100px)]">
